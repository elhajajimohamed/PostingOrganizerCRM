  ...
  useEffect(() => {
    ...
    if (viewMode === 'today') {
      ...
      filtered = filtered.filter(task => {
        const isToday = task.date >= startOfDay && task.date < endOfDay;
        ...
        if (task.notes) {
          try {
            ...
            if (parsedNotes && typeof parsedNotes === 'object') {
              ...
              isAutoGeneratedPostingTask = parsedNotes.title?.startsWith('Auto-generated schedule') ||
                                          parsedNotes.description?.startsWith('Auto-generated schedule');
            } else {
              // Check raw notes string
              isAutoGeneratedPostingTask = task.notes.startsWith('Auto-generated schedule');
            }
          } catch (error) {
